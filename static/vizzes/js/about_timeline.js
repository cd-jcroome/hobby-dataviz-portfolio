function showTime() {
  ...
  d3.tsv(
    "https://gist.githubusercontent.com/Jasparr77/4f1f0fe8e08792dcf3cdf9ba089618b4/raw/7f9630cb6ccec3fc17d049c98f993fdaedaab130/aboutJasper.tsv",
    function (data) {
      data.forEach(function (d) {
        d.start = parseTime(d.start);
        d.finish == "Today"
          ? (d.finish = new Date())
          : (d.finish = parseTime(d.finish));
      });
      ...
      aboutViz.selectAll(".domain").style("stroke", "none");
    }
  );
}
showTime();
